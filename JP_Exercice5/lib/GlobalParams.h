...
#define CLOCK_DIV_VC3          0x17    // VC3 clock divider
#define CLOCK_DIV_VC3_MASK     0xff    // VC3 clock divider mask
#define CLOCK_DIV_VC3_JUST     0x17    // VC3 clock divider justified
...
#define PORT_0_GLOBAL_SELECT   0x2     //Port 0 global select register (PRT0GS)
...
#define PORT_0_INTENABLE       0x2     //Port 0 interrupt enable register (PRT0IE)
