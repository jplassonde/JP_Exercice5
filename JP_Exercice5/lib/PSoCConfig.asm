...
export LoadConfig_jp_exercice5
export _LoadConfig_jp_exercice5
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_jp_exercice5
	lcall	LoadConfigTBL_jp_exercice5_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration jp_exercice5
;
;    Load configuration registers for jp_exercice5.
...
;               CUR_PP
;
_LoadConfig_jp_exercice5:
 LoadConfig_jp_exercice5:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_jp_exercice5_Bank0
    mov     X, <LoadConfigTBL_jp_exercice5_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_jp_exercice5_Bank1
    mov     X, <LoadConfigTBL_jp_exercice5_Bank1
