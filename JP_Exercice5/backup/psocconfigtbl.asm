...
export LoadConfigTBL_jp_exercice5_Bank1
export LoadConfigTBL_jp_exercice5_Bank0
export LoadConfigTBL_jp_exercice5_Ordered
AREA lit(rom, rel)
LoadConfigTBL_jp_exercice5_Bank0:
...
;  Instance name P0_SHADOW, User Module SHADOWREGS
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_jp_exercice5_Bank1:
;  Instance name Counter16, User Module Counter16
;       Instance name Counter16, Block Name CNTR16_LSB(DBB00)
...
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[01h], 02h		; Port_0_IntEn register (PRT0IE)
